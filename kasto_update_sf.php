...
// $select = mysqli_query($con, $query);
  ...
  $cekUsername = "SELECT * FROM salesforce WHERE `username`='$username'";
  $runCekUsername = mysqli_query($con, $cekUsername);
  $jumlahCekUsername = mysqli_num_rows($runCekUsername);

  $compare = "SELECT `username` FROM salesforce WHERE `username`='$username'";
      ...
      WHERE username='$username'";
       ...
       if ($hasilQueryUser){
         echo '<script language="JavaScript">
          ...
          window.location = "kasto_tampil_sf.php";
          </script>';
       } else {
         echo '<script language="JavaScript">
...
window.location = "kasto_edit_sf.php";
</script>';
<?php
include("kasto_tampil_sf.php");
}
 ?>
