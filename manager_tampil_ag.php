            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h2 class="title text-center"><b>List Anggota Admin Agency</b></h2><br><br>
                                <br><br>
                                <a class="btn btn-success" href="manager_input_ag.php" style="font-size:12pt">+ Input Data
                                    Baru</a>
                                <a class="btn btn-success" href="manager_import_ag.php"style="font-size:12pt">Import Data Excel</a>
                                <br><br><br>
                                ...
                                <form action="" method="post">
                                  ...
                                  <a>
                                      <form method=post action=manager_tampil_ag.php>
                            ...
                            <div class="content">
                              <div class="table-responsive" style="height:55vh;overflow:scroll">
                                  <?php include("manager_tabel_ag.php"); ?>
                              </div>
