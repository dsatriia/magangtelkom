<?php
  ...
  $kumpulanUser = query("SELECT * FROM detail_picwitel WHERE akses = 10");
...
<tr>
            ...
            <td><a href="picwitel_edit_kasto.php?id_picwitel=<?= $user['id_picwitel'] ?>" name="btn-edit"
                onclick="return confirm(&quot;Yakin Ingin Mengedit Data User?&quot;);">Edit</a> | <a
                href="picwitel_hapus_kasto.php?id_picwitel=<?= $user['id_picwitel'] ?>" name="btn-edit"
