  ...
  //  $id_manager = $_SESSION['id_manager'];
    ...
    echo "<tr>"; ?>
      ...
      <td><?php echo $data['akses'] ?></td>
            <td><a href="list_manager_hapus.php?id_manager=<?php echo $data['id_manager'] ?>" name="btn-delete" onClick='return confirm("Yakin Ingin Menghapus User?");'>Hapus</a></td>
