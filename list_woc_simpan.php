...
$query = "SELECT * FROM woc WHERE username='$username'";
$select = mysqli_query($con, $query);

  $cekUsername = "SELECT `username` FROM woc WHERE `username`='$username'";
 ...
 $query = "INSERT INTO woc (username, password, nama)
