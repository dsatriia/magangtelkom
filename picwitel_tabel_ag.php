...
<tr>
          ...
          <td><?= $Agency ?></td>
            ...
            <td><a href="picwitel_edit_ag.php?id_admin_agency=<?= $user['id_admin_agency'] ?>" name="btn-edit"
                onclick="return confirm(&quot;Yakin Ingin Mengedit Data User?&quot;);">Edit</a> | <a
                href="picwitel_hapus_ag.php?id_admin_agency=<?= $user['id_admin_agency'] ?>" name="btn-edit"
