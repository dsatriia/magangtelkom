                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                ...
                                <br><br>
                                <a class="btn btn-success" href="manager_input_kasto.php" style="font-size:12pt">+ Input User Baru</a>
                                <a class="btn btn-success" href="manager_import_kasto.php"style="font-size:12pt">Import Data Excel</a>
                                <br><br><br>
                                ...
                                <form action="" method="post">
                                  ...
                                  <a>
                                      <form method=post action=manager_tampil_kasto.php>
                            ...
                            <div class="content">
                              <div class="table-responsive" style="height:70vh;overflow:scroll">
                                  <?php include("manager_tabel_kasto.php"); ?>
                              </div>
                            </div>
                        </div>
                    </div>
