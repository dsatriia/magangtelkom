...
// $id_supervisor = $_SESSION['id_supervisor'];
    $queryAg = "SELECT * FROM agency";
    $hasilAg = mysqli_query($con,$queryAg);
    // while ($dataAg = mysqli_fetch_array($hasilAg)){
?>
...
<div>
            ...
            <form method="post" action="list_spv_simpan.php">
                <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <?php foreach($hasilAg as $id_agency) : ?>
                                <option value="<?=$id_agency['id_agency'] ?> "><?= $id_agency['nama'] ?></option>
                            <?php endforeach ?>  
                            </select>
                        </div>               
