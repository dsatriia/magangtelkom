<?php
  ...
  $kumpulanUser = query("SELECT * FROM detail_teknis WHERE akses = 7");
...
<tr>
            ...
            <td><a href="picwitel_edit_woc.php?id_teknis=<?= $user['id_teknis'] ?>" name="btn-edit"
                onclick="return confirm(&quot;Yakin Ingin Mengedit Data User?&quot;);">Edit</a> | <a
                href="picwitel_hapus_woc.php?id_teknis=<?= $user['id_teknis'] ?>" name="btn-edit"
