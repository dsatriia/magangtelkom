...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 18, 2020 at 08:58 AM
...
CREATE TABLE `data_pelanggan` (
  `id` int(15) NOT NULL,
  `track_id` varchar(15) COLLATE latin1_general_cs NOT NULL,
  `nama_pelanggan` varchar(25) COLLATE latin1_general_cs NOT NULL,
  `alamat` varchar(50) COLLATE latin1_general_cs NOT NULL,
  `ktp` varchar(20) COLLATE latin1_general_cs NOT NULL,
  `sto` int(11) NOT NULL,
  `second_cp` varchar(25) COLLATE latin1_general_cs NOT NULL,
  `paket` varchar(25) COLLATE latin1_general_cs NOT NULL,
  `tagging_rill` varchar(25) COLLATE latin1_general_cs NOT NULL,
  `odp` varchar(25) COLLATE latin1_general_cs NOT NULL,
  `odp_ke_pelanggan` varchar(25) COLLATE latin1_general_cs NOT NULL,
  `tgl_input` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `no_sc` varchar(25) COLLATE latin1_general_cs NOT NULL,
  `status_validasi` varchar(7) COLLATE latin1_general_cs NOT NULL,
  `kategori_progress_psb` varchar(25) COLLATE latin1_general_cs NOT NULL,
  `keterangan_progress_psb` varchar(50) COLLATE latin1_general_cs NOT NULL,
  `alamat_rill_pelanggan` varchar(50) COLLATE latin1_general_cs NOT NULL,
  `cp_rill_pelanggan` varchar(25) COLLATE latin1_general_cs NOT NULL,
  `nama_teknisi` varchar(25) COLLATE latin1_general_cs NOT NULL,
...
CREATE TABLE `sto` (
  `id` int(11) NOT NULL,
  `area` varchar(15) COLLATE latin1_general_cs NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_general_cs;
...
CREATE TABLE `user` (
  `id` int(3) NOT NULL,
  `username` varchar(25) COLLATE latin1_general_cs NOT NULL,
  `password` varchar(25) COLLATE latin1_general_cs NOT NULL,
  `akses` int(1) NOT NULL,
  `nama` varchar(25) COLLATE latin1_general_cs NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_general_cs;
