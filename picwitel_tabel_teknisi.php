<?php
  ...
  // $kumpulanUser = query("SELECT * FROM detail_teknis WHERE id_teknis != 0 ORDER BY id_agency");
  $kumpulanUser = query("SELECT * FROM detail_teknis WHERE akses = 5");
...
<tr>
            ...
            <td><a href="picwitel_edit_teknisi.php?id_teknis=<?= $user['id_teknis'] ?>" name="btn-edit"
                onclick="return confirm(&quot;Yakin Ingin Mengedit Data User?&quot;);">Edit</a> | <a
                href="picwitel_hapus_teknisi.php?id_teknis=<?= $user['id_teknis'] ?>" name="btn-edit"
