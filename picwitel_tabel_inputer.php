...
<tr>
            ...
            <td><a href="picwitel_edit_inputer.php?id_picwitel=<?= $user['id_picwitel'] ?>" name="btn-edit"
                onclick="return confirm(&quot;Yakin Ingin Mengedit Data User?&quot;);">Edit</a> | <a
                href="picwitel_hapus_inputer.php?id_picwitel=<?= $user['id_picwitel'] ?>" name="btn-edit"
