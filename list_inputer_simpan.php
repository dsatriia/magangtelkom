...
$query = "SELECT * FROM inputer WHERE username='$username'";
$select = mysqli_query($con, $query);

  $cekUsername = "SELECT `username` FROM inputer WHERE `username`='$username'";
 ...
 $query = "INSERT INTO inputer (username, password, nama)
...
<?php
include("list_inputer_input.php");
}
?>
