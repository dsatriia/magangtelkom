...
<tr>
            ...
            <td><a href="manager_edit_picwitel.php?id_picwitel=<?= $user['id_picwitel'] ?>" name="btn-edit"
                onclick="return confirm(&quot;Yakin Ingin Mengedit Data User?&quot;);">Edit</a> | <a
                href="manager_hapus_picwitel.php?id_picwitel=<?= $user['id_picwitel'] ?>" name="btn-edit"
