            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h2 class="title text-center"><b>List Anggota Supervisor</b></h2><br><br>
                                <br><br>
                                <a class="btn btn-success" href="picwitel_input_spv.php" style="font-size:12pt">+ Input User
                                    Baru</a>
                                <a class="btn btn-success" href="picwitel_import_spv.php"style="font-size:12pt">Import Data Excel</a>
                                <br><br><br>
                                ...
                                <form action="" method="post">
                                  ...
                                  <a>
                                      <form method=post action=picwitel_tampil_spv.php>
                            ...
                            <div class="content">
                              <div class="table-responsive" style="height:70vh;overflow:scroll">
                                  <?php include("picwitel_tabel_spv.php"); ?>
                              </div>
