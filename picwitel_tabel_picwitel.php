<?php
  ...
  $kumpulanUser = query("SELECT * FROM detail_picwitel WHERE akses = 9");
...
<tr>
            ...
            <td><a href="picwitel_edit_picwitel.php?id_picwitel=<?= $user['id_picwitel'] ?>" name="btn-edit"
                onclick="return confirm(&quot;Yakin Ingin Mengedit Data User?&quot;);">Edit</a> | <a
                href="picwitel_hapus_picwitel.php?id_picwitel=<?= $user['id_picwitel'] ?>" name="btn-edit"
