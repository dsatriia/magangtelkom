                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                ...
                                <br><br>
                                <a class="btn btn-success" href="picwitel_input_teknisi.php" style="font-size:12pt">+ Input User Baru</a>
                                <a class="btn btn-success" href="picwitel_import_teknisi.php"style="font-size:12pt">Import Data Excel</a>
                                <br><br><br>
                                ...
                                <form action="" method="post">
                                  ...
                                  <a>
                                      <form method=post action=picwitel_tampil_teknisi.php>
                            ...
                            <div class="content">
                              <div class="table-responsive" style="height:70vh;overflow:scroll">
                                  <?php include("picwitel_tabel_teknisi.php"); ?>
                              </div>
                            </div>
                        </div>
                    </div>
