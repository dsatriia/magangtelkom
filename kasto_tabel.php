...
<?php
    ...
    echo "<tr>"; ?>
      ...
      <td><?php echo $p['nama_teknisi'] ?></td>
            <td><a href="kasto_edit.php?id=<?php echo $p['id'] ?>" name="btn-edit" onClick='return confirm("Yakin Ingin Mengedit Data?");'>Edit</a> | <a href="kasto_hapus_pelanggan.php?id=<?php echo $p['id'] ?>" name="btn-edit" onClick='return confirm("Yakin Ingin Menghapus Data?");'>Delete</a></td>
