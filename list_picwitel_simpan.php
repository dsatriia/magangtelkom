...
$query = "SELECT * FROM picwitel WHERE username='$username'";
$select = mysqli_query($con, $query);

  $cekUsername = "SELECT `username` FROM picwitel WHERE `username`='$username'";
 ...
 $query = "INSERT INTO picwitel (username, password, nama)
...
<?php
include("list_picwitel_input.php");
}
?>
