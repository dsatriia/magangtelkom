                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                ...
                                <br><br>
                                <a class="btn btn-success" href="picwitel_input_ag.php" style="font-size:12pt">+ Input Data
                                    Baru</a>
                                ...
                                <form action="" method="post">
                                  ...
                                  <a>
                                      <form method=post action=picwitel_tampil_ag.php>
                            ...
                            <div class="content">
                              <div class="table-responsive" style="height:55vh;overflow:scroll">
                                  <?php include("picwitel_tabel_ag.php"); ?>
                              </div>
