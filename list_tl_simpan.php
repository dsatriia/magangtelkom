...
$query = "SELECT * FROM tl WHERE username='$username'";
$select = mysqli_query($con, $query);

  $cekUsername = "SELECT `username` FROM tl WHERE `username`='$username'";
 ...
 $query = "INSERT INTO tl (username, password, nama)
