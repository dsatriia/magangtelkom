...
include("koneksi.php");
    ...
    echo "<tr>"; ?>
            ...
            <td><a href="barang_edit.php?id=<?php echo $data['id'] ?>" name="btn-edit" onClick='return confirm("Yakin ingin meng-edit data?");'>Edit</a></td>
           <?php /* <td><a href="barang_hapus.php?id_barang=<?php echo $data['id_barang'] ?>" name="btn-hapus" onClick='return confirm("Yakin ingin menghapus data?");'>Hapus</a></td> */ ?>
<?php echo "</tr>";         
       }         
?>             
</tbody>
