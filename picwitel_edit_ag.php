...
<?php
require("koneksi.php");
$id = $_GET['id_admin_agency'];
$query = "SELECT * FROM admin_agency WHERE id_admin_agency = '$id'";
...
<form method='post' action='picwitel_update_ag.php'
...
<?php
include("picwitel_tampil_ag.php");
}
?>
