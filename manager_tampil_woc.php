                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                ...
                                <br><br>
                                <a class="btn btn-success" href="manager_input_woc.php" style="font-size:12pt">+ Input User Baru</a>
                                <a class="btn btn-success" href="manager_import_woc.php"style="font-size:12pt">Import Data Excel</a>
                                <br><br><br>
                                <form action="" method="post">
                                  <div class="form-group">
                                      ...
                                      <form method=post action=manager_tampil_woc.php>
                            ...
                            <div class="content">
                              <div class="table-responsive" style="height:70vh;overflow:scroll">
                                  <?php include("manager_tabel_woc.php"); ?>
                              </div>
                            </div>
                        </div>
                    </div>
