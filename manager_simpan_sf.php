...
// $select = mysqli_query($con, $query);
 ...
 $query = "INSERT INTO salesforce (username, password, nama, id_agency, id_admin_agency, id_supervisor, id_sto, email, telpon, hp, regional, witel, datel, akses)
 VALUES ('$username', '$password', '$nama', '$id_agency', '$id_admin_agency', '$id_supervisor', '$id_sto', '$email', '$telpon', '$hp', '$regional', '$witel', '$datel', '$akses')";
