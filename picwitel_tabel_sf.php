...
<tr>
          ...
          echo $supervisor ?>
            ...
            <td><a href="picwitel_edit_sf.php?id_salesforce=<?= $user['id_salesforce'] ?>" name="btn-edit"
                onclick="return confirm(&quot;Yakin Ingin Mengedit Data User?&quot;);">Edit</a> | <a
                href="picwitel_hapus_sf.php?id_salesforce=<?= $user['id_salesforce'] ?>" name="btn-edit"
