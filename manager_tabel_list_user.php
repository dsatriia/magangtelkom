    ...
    <div class="container-fluid">
            ...
            <ul class="nav">
                <li <?php if(isset($page) && $page == 1): echo "class='active'"; endif ?>>
                  <div class="header">
                      <a href="manager_tampil_ag.php">
                      <button type="submit" class="btn btn-default" style="font-size:14pt; width: 250px"><b>Admin Agency</b></button>
                      </a>
                  </div>
                </li>
                <li <?php if(isset($page) && $page == 2): echo "class='active'"; endif ?>>
                  <div class="header">
                      <a href="manager_tampil_spv.php">
                      <button type="submit" class="btn btn-default" style="font-size:14pt; width: 250px"><b>Supervisor</b></button>
                      </a>
                  </div>
                </li>
                <li <?php if(isset($page) && $page == 3): echo "class='active'"; endif ?>>
                  <div class="header">
                      <a href="manager_tampil_sf.php">
                      <button type="submit" class="btn btn-default" style="font-size:14pt; width: 250px"><b>Sales Force</b></button>
                      </a>
                  </div>
                </li>
                <li <?php if(isset($page) && $page == 4): echo "class='active'"; endif ?>>
                  <div class="header">
                      <a href="manager_tampil_inputer.php">
                ...
                <li <?php if(isset($page) && $page == 5): echo "class='active'"; endif ?>>
                  <div class="header">
                      <a href="manager_tampil_teknisi.php">
                ...
                <li <?php if(isset($page) && $page == 8): echo "class='active'"; endif ?>>
                  <div class="header">
                      <a href="manager_tampil_manager.php">
                ...
                <li <?php if(isset($page) && $page == 9): echo "class='active'"; endif ?>>
                  <div class="header">
                      <a href="manager_tampil_picwitel.php">
                ...
                <li <?php if(isset($page) && $page == 10): echo "class='active'"; endif ?>>
                  <div class="header">
                      <a href="manager_tampil_kasto.php">
